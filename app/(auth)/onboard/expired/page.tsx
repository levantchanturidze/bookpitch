  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-slate-50 px-4">
      <div className="w-full max-w-md rounded-2xl border border-slate-200 bg-white p-8 shadow-sm text-center">
        ...
        <h1 className="text-lg font-extrabold tracking-tight text-slate-900">Link expired or invalid</h1>
        <p className="mt-2 text-sm text-slate-500">
          Your verification link has expired or has already been used. Verification links are
          valid for 24 hours and can only be clicked once.
        </p>
        <a
          href="/signup"
