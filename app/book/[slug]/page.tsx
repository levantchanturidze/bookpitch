...
export default async function PublicBookingPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  if (!loc) notFound();
  return (
    <main id="main" className="mx-auto min-h-screen max-w-2xl bg-slate-50 px-4 py-8">
      <header className="mb-6">
        <h1 className="text-xl font-extrabold tracking-tight text-slate-900">{loc.locationName}</h1>
