  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        ...
        {maskPii && (
          <span className="rounded-md bg-amber-950 px-2 py-1 font-mono text-[10px] tracking-wider text-amber-200 uppercase">
            ...
            {rows.map((r) => (
              <tr key={r.id}>
                ...
                <td className="px-2 py-1 text-[10px]">
                  {r.impersonationSessionId && (
                    <span className="rounded bg-amber-950 px-1 py-0.5 text-amber-200">imp</span>
                  )}
                  {r.breakGlassSessionId && (
                    <span className="ml-1 rounded bg-red-950 px-1 py-0.5 text-red-200">bg</span>
                  )}
                </td>
              </tr>
            ))}
