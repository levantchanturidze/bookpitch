...
| 2026-08-10 | Bootstrap SUPER_ADMIN in production | Migration `20260810000002_bootstrap_platform_admin` creates `levaaani@gmail.com` as `SUPER_ADMIN` if no platform admin exists. Temporary password: `Bookpitch2026!` — change after first sign-in. |
